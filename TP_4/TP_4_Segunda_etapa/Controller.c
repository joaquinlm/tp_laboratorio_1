...
{
  LinkedList *aux = NULL;
  int opcion = imprimirMenuFiltros();
  if (pArrayListEmployee != NULL)
  {
    if (opcion != 7)
    {
      ...
      case 1:
        aux = ll_filter(pArrayListEmployee, filterIdUpTo500);
        break;

      case 2:
        aux = ll_filter(pArrayListEmployee, filterIdOver500);
        break;

      case 3:
        aux = ll_filter(pArrayListEmployee, filterHoursUpTo160);
        break;

      case 4:
        aux = ll_filter(pArrayListEmployee, filterHoursOver160);
        break;

      case 5:
        aux = ll_filter(pArrayListEmployee, filterSalaryUpTo25000);
        break;

      case 6:
        aux = ll_filter(pArrayListEmployee, filterSalaryOver25000);
        break;
      }
    }
  }
...
int controller_filterAndSaveBin(LinkedList *pArrayListEmployee)
{
  ...
  int opcion = imprimirMenuFiltrosBin();
  if (pArrayListEmployee != NULL && aux != NULL)
  {
    if (opcion != 7)
    {
      ...
      case 1:
        aux = ll_filter(pArrayListEmployee, filterIdUpTo500);
        controller_saveAsBinary("upto500.bin", aux);
        break;

      case 2:
        aux = ll_filter(pArrayListEmployee, filterIdOver500);
        controller_saveAsBinary("over500.bin", aux);
        break;

      case 3:
        aux = ll_filter(pArrayListEmployee, filterHoursUpTo160);
        controller_saveAsBinary("upto160h.bin", aux);
        break;

      case 4:
        aux = ll_filter(pArrayListEmployee, filterHoursOver160);
        controller_saveAsBinary("over160h.bin", aux);
        break;

      case 5:
        aux = ll_filter(pArrayListEmployee, filterSalaryUpTo25000);
        controller_saveAsBinary("supto25000.bin", aux);
        break;

      case 6:
        aux = ll_filter(pArrayListEmployee, filterSalaryOver25000);
        controller_saveAsBinary("sover25000.bin", aux);
        break;
      }
    }
    todoOk = 1;
...
int controller_filterAndSaveTxt(LinkedList *pArrayListEmployee)
{
  ...
  if (pArrayListEmployee != NULL && aux != NULL)
  {
    if (opcion != 7)
    {
      ...
      case 1:
        aux = ll_filter(pArrayListEmployee, filterIdUpTo500);
        controller_saveAsText("filterIdUpTo500.csv", aux);
        break;

      case 2:
        aux = ll_filter(pArrayListEmployee, filterIdOver500);
        controller_saveAsText("over500.csv", aux);
        break;

      case 3:
        aux = ll_filter(pArrayListEmployee, filterHoursUpTo160);
        controller_saveAsText("upto160h.csv", aux);
        break;

      case 4:
        aux = ll_filter(pArrayListEmployee, filterHoursOver160);
        controller_saveAsText("over160h.csv", aux);
        break;

      case 5:
        aux = ll_filter(pArrayListEmployee, filterSalaryUpTo25000);
        controller_saveAsText("supto25000.csv", aux);
        break;

      case 6:
        aux = ll_filter(pArrayListEmployee, filterSalaryOver25000);
        controller_saveAsText("sover25000.csv", aux);
        break;
      }
    }
    todoOk = 1;
...
int controller_ClearLinkedList(LinkedList *pArrayListEmployee)
{
...

  {
    ...
    if (confirma == 's')
    {
      todoOk = ll_clear(pArrayListEmployee);
    }
